...
class PropertyManagementAPITester:
    def __init__(self, base_url="https://property-hub-dev-1.preview.emergentagent.com"):
    ...
    def test_staff_crud(self):
        ...
        created_staff = self.run_test("Create housekeeper staff", "POST", "api/staff", 201, staff_data)
        if created_staff:
